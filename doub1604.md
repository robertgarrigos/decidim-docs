...
```
Then,
- To create a new development app, run bin/rake development_app.
- To create a new production app, run bundle exec decidim-generators/exe/decidim production_app.
